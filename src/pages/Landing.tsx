    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <section className="pt-32 pb-20 px-4 relative">
        ...
        <div className="container mx-auto text-center max-w-4xl relative z-10">
          <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full text-sm font-medium mb-6 animate-slideDown">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight animate-slideUp">
            ...
            <span className="text-gradient block mt-2">Symptom Checker</span>
          </h1>

          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto animate-slideUp" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="flex gap-4 justify-center flex-wrap mb-12 animate-slideUp" style={{ animationDelay: "0.2s" }}>
            <Button
              size="lg"
              className="text-lg gradient-primary hover-lift group"
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto mb-12 animate-scaleIn" style={{ animationDelay: "0.3s" }}>
          ...
          {/* Medical Disclaimer */}
          <div className="mt-12 p-4 glass rounded-lg text-sm text-left max-w-2xl mx-auto border-l-4 border-warning animate-slideUp" style={{ animationDelay: "0.4s" }}>
      ...
      <button
        onClick={() => navigate("/auth?tab=signup")}
        className="fixed bottom-8 right-8 w-14 h-14 rounded-full gradient-rainbow shadow-lg hover-lift z-50 flex items-center justify-center group"
